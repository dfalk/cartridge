...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.available_in_stock'
        db.add_column('shop_product', 'available_in_stock',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.available_in_stock'
        db.delete_column('shop_product', 'available_in_stock')
