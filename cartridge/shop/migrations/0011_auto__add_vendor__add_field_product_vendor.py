...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('shop', ['Vendor'])

        # Adding field 'Product.vendor'
        db.add_column('shop_product', 'vendor',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Vendor'], null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting model 'Vendor'
        db.delete_table('shop_vendor')
