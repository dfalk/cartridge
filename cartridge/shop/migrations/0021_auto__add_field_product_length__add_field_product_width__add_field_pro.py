...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('shop_product', 'length',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.width'
        db.add_column('shop_product', 'width',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.height'
        db.add_column('shop_product', 'height',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Product.weight'
        db.add_column('shop_product', 'weight',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('shop_product', 'length')

        # Deleting field 'Product.width'
        db.delete_column('shop_product', 'width')

        # Deleting field 'Product.height'
        db.delete_column('shop_product', 'height')

        # Deleting field 'Product.weight'
        db.delete_column('shop_product', 'weight')
    ...
    models = {
        ...
        'shop.order': {
            ...
            'billing_detail_email': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'blank': 'True'}),
            ...
            'billing_type': ('django.db.models.fields.CharField', [], {'max_length': '50', 'blank': 'True'}),
        ...
        'shop.product': {
            'Meta': {'ordering': "['-available_in_stock', 'position']", 'object_name': 'Product'},
            '_meta_title': ('django.db.models.fields.CharField', [], {'max_length': '500', 'null': 'True', 'blank': 'True'}),
            'available': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'available_in_stock': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
